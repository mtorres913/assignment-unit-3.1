...
let favoriteFoods = ['italian', 'mexican', 'chinese', 'hawaiian'];
...
favoriteFoods.unshift('japanese');
...
favoriteFoods[1] = 'vietnamese'
console.log('Replaced second food, mexican')
console.log('The foods are now', favoriteFoods)
